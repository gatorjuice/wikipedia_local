...
DUMP_FILE=/var/www/html/enwiki-latest-pages-articles1.xml-p1p41242.bz2
...
if [ ! -f "/var/www/html/enwiki-latest-pages-articles1.xml-p1p41242" ]; then
...
php /var/www/html/maintenance/importDump.php /var/www/html/enwiki-latest-pages-articles1.xml-p1p41242
